    ...
    timestamps {
        try {
            ...
            stage('Docker Build & Push') {
                ...
                withCredentials([string(credentialsId: '4710ad4f-2401-4a57-b9d0-7ff395aefad5', variable: 'Docker-PAT')]) {
                def customImage1 = docker.build("bonsai/${SERVICE_NAME}-main", "-f ${dockerfile1} .")
                def customImage2 = docker.build("bonsai/${SERVICE_NAME}-action", "-f ${dockerfile2} .")
